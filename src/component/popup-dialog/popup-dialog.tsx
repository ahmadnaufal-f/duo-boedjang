import { Concert_One, Exo } from "next/font/google"
...
const exo = Exo({ weight: ["700"], subsets: ["latin"] })
                    ...
                    >
                        <div className={styles.dialogContent}>
                            ...
                            <ul>
                                ...
                                <li>
                                    <span className={exo.className}>*</span>Bahan baku sudah termasuk: bubuk coklat, skm, susu, air, dan es batu
                                </li>
                                <li>
                                    <span className={exo.className}>*</span>Harga bahan baku mengikuti harga JABODETABEK
                                </li>
                                <li>Belum termasuk ongkos kirim, biaya sewa lokasi, dan gaji karyawan</li>
